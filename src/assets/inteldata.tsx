    ...
    useEffect(() => {
      ...
      if (!isControlledRef.current && isInView) {
        ...
        interval = setInterval(async () => {
          controls.start('normal'); // Reset instantly
          // Small delay to ensure the reset is processed, though start returns a promise so awaiting might be enough, 
          // but we want to make sure it's visually perceptible as a new animation 
          setTimeout(() => {
             controls.start('animate');
          }, 100);
        }, 5000);
